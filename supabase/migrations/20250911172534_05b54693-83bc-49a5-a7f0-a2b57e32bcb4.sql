-- Add new role for construction support
INSERT INTO public.profiles (user_id, display_name, email, role, department)
SELECT gen_random_uuid(), 'Obsługa Budowy', 'obsluga@example.com', 'obsluga_budowy', 'Obsługa Budowy'
WHERE NOT EXISTS (SELECT 1 FROM public.profiles WHERE role = 'obsluga_budowy');
